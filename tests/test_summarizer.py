...
class TestSummarizer:
    ...
    def test_initialization_with_openai(self):
        ...
        with patch('summarizer.OPENAI_AVAILABLE', True), \
             patch('summarizer.OpenAI') as mock_openai_class:
    ...
    def test_initialization_without_openai(self):
        ...
        with patch('summarizer.OPENAI_AVAILABLE', False):
            summarizer = Summarizer(self.config)
    ...
    @patch('summarizer.OPENAI_AVAILABLE', True)
