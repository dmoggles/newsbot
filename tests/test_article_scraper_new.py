...
class TestArticleScraper:
    ...
    @patch("article_scraper.detect")
    def test_detect_language_unavailable(self, mock_detect):
        """Test language detection when library raises import error."""
    ...
    def test_scrape_with_trafilatura(self, mock_trafilatura):
        ...
        mock_trafilatura.extract.return_value = (
            "This is extracted content that is long enough to pass validation checks." * 10
        )
